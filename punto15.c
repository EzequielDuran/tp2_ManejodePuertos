//Diseñar una solución programable de manera tal que en el Puerto A se refleje el valor del Puerto B con un desplazamiento lógico a la izquierda. Utilizar el operador <<.
#include "MKL25Z4.h"
int main() {
